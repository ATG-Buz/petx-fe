...
const AddPatientRecord = () => {
  const [activeTab, setActiveTab] = useState("owner"); // owner, pet, treatment, payment
  ...
  return (
    <form onSubmit={handleSubmit} className="p-6 space-y-8">
      ...
      <div className="flex border-b">
        <button
          type="button"
          className={`px-4 py-2 ${activeTab === 'owner' ? 'border-b-2 border-blue-500 text-blue-500' : ''}`}
        ...
        <button
          type="button"
          className={`px-4 py-2 ${activeTab === 'pet' ? 'border-b-2 border-blue-500 text-blue-500' : ''}`}
